              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="h-14 w-14 rounded-full bg-indigo-50/80 border border-indigo-200/80 flex items-center justify-center">
                    <span className="text-xl font-bold text-indigo-700">PH</span>
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-slate-800">Pien van Hoff</span>
                      <CheckCircle
                        className="h-5 w-5 text-emerald-600"
                        aria-label="Verified"
                      />
                    </div>
                    <p className="text-sm text-slate-600">Tilburg University • Economics</p>
                  </div>
                </div>
