...
CREATE INDEX idx_match_suggestions_user ON match_suggestions USING GIN (member_ids);
CREATE INDEX idx_match_suggestions_run_id ON match_suggestions (run_id);
CREATE INDEX idx_match_suggestions_status ON match_suggestions (status);
CREATE INDEX idx_match_suggestions_expires_at ON match_suggestions (expires_at);
CREATE INDEX idx_match_suggestions_fit_index ON match_suggestions (fit_index);

-- Indexes for match_blocklist
CREATE INDEX idx_match_blocklist_user_id ON match_blocklist (user_id);
CREATE INDEX idx_match_blocklist_blocked_user_id ON match_blocklist (blocked_user_id);
