...
-- Replace YOUR_USER_ID with your user ID and OTHER_USER_ID with: 11111111-1111-4111-8111-111111111103
...
SELECT 
    ...
    CASE 
        ...
        WHEN NOT ('11111111-1111-4111-8111-111111111103'::uuid = ANY(ms.accepted_by)) THEN 'Other user not in accepted_by'
...
AND (
    ...
    AND '11111111-1111-4111-8111-111111111103'::uuid = ANY(ms.member_ids)
)
