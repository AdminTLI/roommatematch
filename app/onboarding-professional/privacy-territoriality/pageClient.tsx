...
import itemsJson from '@/data/item-bank.yp.m7.v1.json'
    ...
    <QuestionnaireLayout
      ...
      onPrev={() => {
        window.location.href = isEditMode
          ? '/onboarding-professional/communication-conflict?mode=edit'
          : '/onboarding-professional/communication-conflict'
      }}
      onNext={async () => {
        await saveSection()
        window.location.href = isEditMode
          ? '/onboarding-professional/reliability-logistics?mode=edit'
          : '/onboarding-professional/reliability-logistics'
      }}
