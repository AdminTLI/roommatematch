...
import itemsJson from '@/data/item-bank.yp.m6.v1.json'
...
function SectionClientContent() {
  const sectionKey = 'communication-conflict' as const
    ...
    <QuestionnaireLayout
      ...
      onPrev={() => {
        window.location.href = isEditMode
          ? '/onboarding-professional/social-hosting-language?mode=edit'
          : '/onboarding-professional/social-hosting-language'
      }}
      onNext={async () => {
        await saveSection()
        window.location.href = isEditMode
          ? '/onboarding-professional/privacy-territoriality?mode=edit'
          : '/onboarding-professional/privacy-territoriality'
      }}
