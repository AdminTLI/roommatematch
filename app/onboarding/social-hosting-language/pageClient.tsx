...
export default function SectionClient() {
  ...
  return (
    <QuestionnaireLayout
      ...
      onNext={async () => { await saveSection(); window.location.href = '/onboarding/communication-conflict' }}
      nextDisabled={nextDisabled}
    >
      <AutosaveToaster show={showToast} />
      <div className="flex items-center justify-between">
        <SectionIntro title="Social, Hosting & Language" purpose="Guests, gatherings, and common-language norms." />
