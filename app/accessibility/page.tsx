import { MarketingSubpageWrapper } from '@/app/(marketing)/components/marketing-subpage-wrapper'
...
export default function AccessibilityPage() {
  return (
    <MarketingSubpageWrapper>
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50 bg-violet-600 text-white px-4 py-2 rounded-md transition-all duration-200"
      >
      ...
      <Section className="bg-slate-950">
        <Container>
          <main id="main-content" className="max-w-4xl mx-auto py-12">
            <div className="prose prose-lg prose-invert max-w-none prose-headings:text-white prose-p:text-slate-400 prose-li:text-slate-400 prose-strong:text-white">
