...
export const metadata = { title: 'Contact | Roommate Match' }
    ...
    <main>
      <Section className="bg-white">
        <Container>
          ...
          <p className="text-brand-muted mb-8 max-w-2xl">Questions or feedback? Use the form below or email us at <span className="font-medium">support@roommatematch.app</span>.</p>
