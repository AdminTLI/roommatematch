export const homepageStructuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'Domu Match',
      description:
        'Find compatible roommates in the Netherlands. Smart matching for verified students and young professionals.',
      publisher: {
        '@id': 'https://domumatch.com/#organization',
      },
    ...
    },
    {
      ...
      description:
        'AI-powered roommate matching for verified students and young professionals in the Netherlands',
      brand: {
        '@type': 'Brand',
        name: 'Domu Match',
      },
