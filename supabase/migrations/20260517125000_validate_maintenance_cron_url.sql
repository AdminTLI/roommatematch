-- Guard against misconfigured app_base_url vault secret (placeholder values or missing
-- scheme crash pg_net._encode_url_with_params_array with "Out of memory").
