-- Allow unverified users into the match suggestion pool (Persona deferred to accept).
-- Cohort filtering remains enforced.
...
BEGIN
  ...
  WITH filtered_users AS (
    ...
    WHERE p.user_id != p_user_id
      -- Persona verification no longer required to appear in suggestions
