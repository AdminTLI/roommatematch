...
export const RETENTION_POLICIES: RetentionPolicy[] = [
  ...
  },
  {
    ...
    retentionDays: 365, // 1 year — same as chat messages (DPIA Section 1.1.4)
    description: 'Domu AI assistant conversation logs (user_message + assistant_reply)',
    legalBasis: 'Contractual necessity for providing AI assistant feature; rows are tied to user_id for DSAR/erasure compliance',
    exceptions: []
  }
]
