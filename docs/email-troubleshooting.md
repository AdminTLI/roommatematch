...
4. Fill in your provider. **Mailjet** (recommended for this project):
   ...
   - **Sender email:** Must be a validated sender in Mailjet (e.g. `noreply@domumatch.com`). In Mailjet: **Sender addresses & domains** → add/verify your domain (SPF/DKIM) and ensure the From address is allowed.
